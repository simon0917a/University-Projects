...
public:
    ...
    void showUserRecords() {
        ...
        // setw + run different users ( 70-76 )
    ...
    void PurchaseTokens() {
        ...
        while (true) {
            ...
            if (money != money_int || money_int % 2 == 1 || money_int <= 0) {
                cout << "input an even integer value\n";// Prompt for valid input
